...
// Export Tabs components renamed for use in Dialog
export const DialogTabs = Tabs;
export const DialogTabsList = TabsList;
export const DialogTabsTrigger = TabsTrigger;
export const DialogTabsContent = TabsContent;
