...
const StartupTableRow = ({ startup, status, onRowClick, onDelete }: StartupTableRowProps) => {
  ...
  const handleRowClicked = () => {
    ...
    const formattedStartup = {
      ...
      problem_solved: startup.values['Problema que Resolve'] || startup.values['Problema Resolvido'] || '',
      description: startup.values.Observações || '',
      sector: startup.values.Setor || '',
      business_model: startup.values['Modelo de Negócio'] || '',
      website: startup.values['Site da Startup'] || '',
